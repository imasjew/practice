...
function keep(){
 ...
 sp = setTimeout(walk,15);
}

function walk(){
 if (px <= 0){pu = 0; px = 0;}  if (px >= 480){pu = 0; px = 480;}                  //边缘判定
 if (py <= 0){pi = 0; py = 0;}  if (py >= 480){pi = 0; py = 480;}
 if ((k == 37 || k2 == 37) && px >= 1)  { if(k2 != 0){pu -= Math.sqrt(2)/2}else{pu-=1;}}//加速度生成
 if ((k == 39 || k2 == 39) && px <= 479){ if(k2 != 0){pu += Math.sqrt(2)/2}else{pu+=1;}}
 if ((k == 38 || k2 == 38) && py >= 1)  { if(k2 != 0){pi -= Math.sqrt(2)/2}else{pi-=1;}}
 if ((k == 40 || k2 == 40) && py <= 479){ if(k2 != 0){pi += Math.sqrt(2)/2}else{pi+=1;}} 
 if (k == 0 && pu > 0){pu-=0.5;}  if (k == 0 && pu < 0){pu+=0.5;}                  //松键回速，斜向故障
 if (k == 0 && pi > 0){pi-=0.5;}  if (k == 0 && pi < 0){pi+=0.5;}
 if (pu > 5){pu = 5;}                                                              //限速
 if (pu < (-5)){pu = -5;}
 if (pi > 5){pi = 5;}
 if (pi < (-5)){pi = -5;}
